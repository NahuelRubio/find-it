...
export interface Location { id:string; household_id:string; parent_id:string|null; name:string; type:string; notes:string|null; owner:Owner; deleted_at:string|null; }
